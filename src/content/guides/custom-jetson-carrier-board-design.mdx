...
```mermaid
flowchart TD
    A["≤ 40 TOPS<br/>single-camera<br/>basic depth"] --> B["Orin Nano 8GB<br/>7–25 W<br/>−25 °C min"]
...
```
*Carrier board power tree for a 12–72 V mobile robot, from battery bus to Jetson VDD_IN.*

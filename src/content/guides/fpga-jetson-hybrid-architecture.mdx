...
The Jetson can ask the FPGA to *consider* a stop. The Jetson cannot ask the FPGA to *defer* a stop. That asymmetry is what makes the architecture safe — and the [AI-native controller primer](/glossary/ai-native-controller-primer) traces why this same asymmetry is what makes the AI side trustable in the first place.
